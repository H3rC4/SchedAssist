...
export const translations = {
  en: {
    ...
    active_instance: 'Active Instance',
    link_required: 'Link Required',
    whatsapp_active_desc: 'Your primary account is linked. Automated reminders and clinical follow-up are active.',
    whatsapp_inactive_desc: 'Connect your WhatsApp Business API account to enable automated reminders and waitlist notifications.',
    qr_notice: 'Business accounts require API configuration. QR pairing is for personal instances.',
    read_docs: 'Read Documentation',
    auto_reminders: 'Automated Reminders',
    reminders_desc: 'Sends automated confirmations 24 hours before scheduled visits.',
    on: 'On',
    off: 'Off',
    clinical_templates: 'Clinical Templates',
    manage_templates: 'Manage Cloud API Templates',
    preview_logic: 'Preview Logic',
    template_conf_text: 'Hello [Patient], your visit is confirmed for [Date] at [Time]. Please confirm attendance.',
    template_wait_text: 'Good news! A slot opened for today at [Time]. Would you like to take it?',
    template_feedback_text: 'Thanks for visiting [Clinic]. Please rate your experience: [Link]',
