...
export const translations = {
  ...
  // Sidebar
    ...
    default_operation_site: 'Default Operation Site',
    agnostic_locations: 'Agnostic (All Locations)',
    to: 'To',
    account_pending: 'Account Pending',
    authorize_professional_desc: 'Authorize this professional to access their precision dashboard.',
    initiate_access: 'Initiate Access',
    decommission_profile: 'Decommission Profile',
    synchronizing_precision: 'Synchronizing Precision',
    auth_profile_active: 'Auth Profile Active',
    login_identifier: 'Login Identifier',
    credentials_hint: 'Credentials Hint',
    chronological_void: 'Chronological Void',
    active_overrides: 'Active Overrides',
    select_date_exceptions: 'Select a date to define temporary operational shifts.',
    danger_appointments_cancelled: (count: number) => `DANGER: ${count} active appointment(s) will be automatically cancelled.`,
    break_active: 'Break Active',
    define_break: 'Define Break',
...
tech_shadcn_desc: 'UX Elegance',
  ...
  // Sidebar
    ...
    core_definition: 'Definición Principal',
    display_name: 'Nombre a Mostrar',
    specialization: 'Especialidad',
    default_operation_site: 'Sede de Operación Predeterminada',
    agnostic_locations: 'Agnóstico (Todas las Sedes)',
    full_throttle: 'Bloqueo Total',
    account_pending: 'Cuenta Pendiente',
    authorize_professional_desc: 'Autoriza a este profesional para acceder a su panel de precisión.',
    initiate_access: 'Iniciar Acceso',
    decommission_profile: 'Dar de Baja Perfil',
    synchronizing_precision: 'Sincronizando Precisión',
    auth_profile_active: 'Perfil de Autenticación Activo',
    login_identifier: 'Identificador de Login',
    credentials_hint: 'Pista de Credenciales',
    chronological_void: 'Vacío Cronológico',
    active_overrides: 'Excepciones Activas',
    select_date_exceptions: 'Selecciona una fecha para definir turnos operativos temporales.',
    danger_appointments_cancelled: (count: number) => `PELIGRO: ${count} cita(s) activa(s) se cancelarán automáticamente.`,
    break_active: 'Descanso Activo',
    define_break: 'Definir Descanso',
  ...
  // Sidebar
    ...
    warning: 'Avviso',
    decommission_profile: 'Disattiva Profilo',
    synchronizing_precision: 'Sincronizzazione Precisione',
    auth_profile_active: 'Profilo Autenticazione Attivo',
    login_identifier: 'Identificativo Login',
    credentials_hint: 'Suggerimento Credenziali',
    chronological_void: 'Vuoto Cronologico',
    active_overrides: 'Eccezioni Attive',
    select_date_exceptions: 'Seleziona una data per definire turnos operativi temporanei.',
    danger_appointments_cancelled: (count: number) => `PERICOLO: ${count} appuntamento/i attivo/i verrà/anno cancellato/i automaticamente.`,
    break_active: 'Pausa Attiva',
    define_break: 'Definisci Pausa',
