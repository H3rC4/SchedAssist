...
export const translations = {
  en: {
    ...
    whatsapp_config_desc: 'Automated Patient Communication Gateway',
    add_new_account: 'Add New Account',
    connect_business_account: 'Connect Business Account',
    ...
    integration_desc_active: 'Your primary account is linked. Automated reminders and clinical follow-ups are active.',
    integration_desc_pending: 'Connect your WhatsApp Business API account to enable automated reminders and sequential waitlist notifications.',
    qr_pairing_note: 'Business accounts require API configuration. Standard QR pairing is for personal instances.',
    read_documentation: 'Read Documentation',
    automated_reminders: 'Automated Reminders',
    automated_reminders_desc: 'Send automatic confirmations 24 hours before scheduled visits.',
    clinical_templates: 'Clinical Templates',
    manage_cloud_api: 'Manage Cloud API Templates',
    preview_logic: 'Preview Logic',
    
    // Notifications Tab
    comm_channels: 'Communication Channels',
    comm_channels_desc: 'Notification Preferences & Alert Logic',
    email_notifications: 'Email Notifications',
    email_notifications_desc: 'Daily activity reports and patient inquiries.',
    ...
    push_alerts_desc: 'Real-time appointment changes and waitlist updates.',
    security_alerts: 'Security Alerts',
    security_alerts_desc: 'Login attempts and administrative changes.',
...
tech_shadcn_desc: 'UX Elegance',
  ...
  // Sidebar
    ...
    whatsapp_config_desc: 'Pasarela de Comunicación Automatizada con Pacientes',
    add_new_account: 'Añadir Nueva Cuenta',
    connect_business_account: 'Conectar Cuenta Business',
    ...
    link_required: 'Vinculación Requerida',
    integration_desc_active: 'Tu cuenta principal está vinculada. Los recordatorios automáticos y seguimientos clínicos están activos.',
    integration_desc_pending: 'Conecta tu cuenta de WhatsApp Business API para habilitar recordatorios automáticos y notificaciones de lista de espera.',
    qr_pairing_note: 'Las cuentas Business requieren configuración de API. El emparejamiento QR estándar es para instancias personales.',
    read_documentation: 'Leer Documentación',
    automated_reminders: 'Recordatorios Automáticos',
    automated_reminders_desc: 'Enviar confirmaciones automáticas 24 horas antes de las visitas programadas.',
    clinical_templates: 'Plantillas Clínicas',
    manage_cloud_api: 'Gestionar Plantillas de Cloud API',
    preview_logic: 'Previsualizar Lógica',
    
    // Notifications Tab
    comm_channels: 'Canales de Comunicación',
    comm_channels_desc: 'Preferencias de Notificación y Lógica de Alertas',
    email_notifications: 'Notificaciones por Email',
    email_notifications_desc: 'Reportes de actividad diaria y consultas de pacientes.',

    // Billing Tab
    billing_settings: 'Suscripción Facturación',
    billing_desc: 'Gestiona la infraestructura digital de tu clínica',
    current_plan: 'Plan Actual',
    professional_plus: 'Profesional Plus',
    ...
    on: 'Activado',
    off: 'Desactivado',
    template_conf_text: 'Hola [Paciente], tu cita ha sido confirmada para el [Fecha] a las [Hora]. Por favor confirma asistencia.',
    template_wait_text: '¡Buenas noticias! Se liberó un cupo para hoy a las [Hora]. ¿Te gustaría tomarlo?',
    template_feedback_text: 'Gracias por visitar [Clínica]. Por favor califica tu experiencia: [Link]',
    push_alerts: 'Alertas Push',
    push_alerts_desc: 'Cambios de citas en tiempo real y actualizaciones de lista de espera.',
    security_alerts: 'Alertas de Seguridad',
    security_alerts_desc: 'Intentos de inicio de sesión y cambios administrativos.',
  ...
  // Sidebar
    ...
    whatsapp_config_desc: 'Gateway di Comunicazione Automatizzata con i Pazienti',
    add_new_account: 'Aggiungi Nuovo Account',
    connect_business_account: 'Collega Account Business',
    ...
    integration_desc_active: 'Il tuo account principale è collegato. I promemoria automatici e i follow-up clinici sono attivi.',
    integration_desc_pending: 'Collega il tuo account WhatsApp Business API per abilitare i promemoria automatici e le notifiche della lista d\'attesa.',
    qr_pairing_note: 'Gli account Business richiedono la configurazione API. L\'accoppiamento QR standard è per le istanze personali.',
    read_documentation: 'Leggi Documentazione',
    automated_reminders: 'Promemoria Automatici',
    automated_reminders_desc: 'Invia conferme automatiche 24 ore prima delle visite programmate.',
    clinical_templates: 'Modelli Clinici',
    manage_cloud_api: 'Gestisci Modelli Cloud API',
    preview_logic: 'Anteprima Logica',
    
    // Notifications Tab
    comm_channels: 'Canali di Comunicazione',
    comm_channels_desc: 'Preferenze di Notifica e Logica degli Avvisi',
    email_notifications: 'Notifiche Email',
    email_notifications_desc: 'Rapporti di attività giornaliera e richieste dei pazienti.',

    // Billing Tab
    billing_settings: 'Abbonamento Fatturazione',
    billing_desc: 'Gestisci l\'infrastruttura digitale della tua clinica',
    current_plan: 'Piano Attuale',
    professional_plus: 'Professionale Plus',
    ...
    template_wait_text: 'Buone notizie! Si è liberato un posto per oggi alle [Ora]. Vorresti prenderlo?',
    template_feedback_text: 'Grazie per aver visitato [Clinica]. Valuta la tua esperienza: [Link]',
    push_alerts: 'Avvisi Push',
    push_alerts_desc: 'Modifiche agli appuntamenti in tempo reale e aggiornamenti della lista d\'attesa.',
    security_alerts: 'Avvisi di Sicurezza',
    security_alerts_desc: 'Tentativi di accesso e modifiche amministrative.',
