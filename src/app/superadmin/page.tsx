  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-12">
      <div className="flex items-end justify-between">
        <div>
          <h1 className="text-4xl font-black text-white tracking-tight mb-2">Clínicas Registradas</h1>
          <p className="text-gray-400 font-medium">Control unificado de todos los inquilinos (Tenants) de la plataforma.</p>
        </div>
        <TenantForm />
      </div>
