...
// If you add a third tenant with Telegram, create a new route and change this constant.
const CHANNEL = 'telegram_gastro';
...
export async function POST(req: NextRequest) {
  ...
  const token = process.env.TELEGRAM_BOT_TOKEN_GASTRO;
  ...
  if (!tenant) {
    console.error('[GASTRO BOT] Tenant not found. Run setup-gastro-tenant script.');
