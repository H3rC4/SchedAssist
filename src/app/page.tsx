...
export default function LandingPage() {
  return (
    <div className="flex min-h-screen flex-col bg-[#090a0d] font-sans selection:bg-accent-500/30 selection:text-accent-950 overflow-x-hidden relative">

      <div className="fixed inset-0 bg-gradient-to-b from-accent-500/[0.02] via-transparent to-transparent pointer-events-none -z-20" />
      ...
      <footer className="relative z-10 py-24 border-t border-white/[0.04] bg-[#090a0d] px-6 overflow-hidden">
         <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-64 bg-accent-500/[0.03] blur-[100px] rounded-full -z-10 pointer-events-none" />
