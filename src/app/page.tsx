...
export default function LandingPage() {
  return (
    <div className="flex min-h-screen flex-col bg-primary-950 font-sans selection:bg-primary-light/30 selection:text-primary-200 overflow-x-hidden relative">
      ...
      <div className="relative">
         <div className="absolute top-0 left-0 right-0 h-64 bg-gradient-to-b from-primary-950 to-transparent z-0" />
      ...
      <footer className="relative z-10 py-24 border-t border-white/5 bg-primary-950 px-6 overflow-hidden">
         <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-64 bg-primary-light/5 blur-[100px] rounded-full -z-10 pointer-events-none" />
