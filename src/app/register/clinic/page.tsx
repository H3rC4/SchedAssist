...
import { Building, ShieldCheck, Loader2, ArrowRight } from 'lucide-react';
        ...
        <div className="bg-white dark:bg-slate-900 rounded-[3rem] shadow-2xl p-8 md:p-12 border border-slate-200/50 dark:border-slate-800/50">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm font-semibold text-slate-500 mt-2">
              Ya estás autenticado. Solo falta bautizar tu negocio para crear tu espacio de trabajo.
            </p>
          </div>
