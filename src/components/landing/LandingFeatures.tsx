...
export function LandingFeatures() {
  ...
  const features: FeatureData[] = [
    {
      title: t.grid_1_title || 'Agenda Inteligente',
      desc: t.grid_1_desc || 'Vista semanal con todos los turnos organizados por profesional. Colores por estado y arrastre para reprogramar.',
      icon: BarChart3,
      preview: <CalendarPreview />,
      className: 'md:col-span-8',
    },
    {
      title: t.grid_2_title || 'WhatsApp AI',
      desc: t.grid_2_desc || 'Confirmaciones automáticas, recordatorios y cancelaciones vía WhatsApp sin intervención humana.',
      icon: MessageCircle,
      preview: <WhatsAppPreview />,
      className: 'md:col-span-4',
    },
    {
      title: t.grid_3_title || 'Dashboard Analytics',
      desc: t.grid_3_desc || 'Métricas en tiempo real: turnos, pacientes, ingresos y tasas de cumplimiento.',
      icon: BarChart2,
      preview: <DashboardPreview />,
      className: 'md:col-span-4',
    },
    {
      title: t.grid_4_title || 'Pagos Integrados',
      desc: t.grid_4_desc || 'Cobros automáticos vía Stripe. Tarjetas de crédito, débito y transferencias.',
      icon: CreditCard,
      preview: <PaymentsPreview />,
      className: 'md:col-span-4',
    },
    {
      title: t.grid_5_title || 'Historias Clínicas',
      desc: t.grid_5_desc || 'Registro completo de cada paciente con diagnósticos, prescripciones y notas médicas.',
      icon: BrainCircuit,
