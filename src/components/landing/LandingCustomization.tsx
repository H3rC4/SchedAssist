...
export function LandingCustomization() {
  ...
  const details = [
    {
      ...
      icon: CalendarDays,
      color: 'bg-primary-light/10 text-primary-light group-hover:bg-primary-light group-hover:text-primary-950'
    },
    {
  ...
  return (
    <section className="relative z-10 px-6 py-32 overflow-hidden bg-primary-950">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {details.map((detail, idx) => (
            <motion.div 
              ...
              className="bg-white/5 p-10 rounded-[3.5rem] border border-white/5 hover:border-primary-light/30 transition-all duration-500 group relative overflow-hidden"
            >
              ...
              <p className="text-white/70 font-medium leading-relaxed">{detail.desc}</p>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="mt-32 flex flex-col items-center gap-10 p-16 rounded-[4rem] bg-primary-950 border border-white/5 text-center relative overflow-hidden"
        >
           <div className="absolute inset-0 noise opacity-10 pointer-events-none" />
           ...
           <Link 
             href="/register" 
             className="px-12 py-6 rounded-[2rem] bg-primary-light hover:bg-primary-200 text-primary-950 text-xs font-black uppercase tracking-[0.2em] transition-all shadow-2xl shadow-primary-light/30 hover:scale-105 active:scale-95 flex items-center gap-4 group"
           >
