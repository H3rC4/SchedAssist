    ...
    <section className="relative z-10 px-6 py-32 overflow-hidden bg-[#090a0d]">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {details.map((detail, idx) => (
            <motion.div 
              ...
              className="bg-white/[0.03] p-10 rounded-[3.5rem] border border-white/[0.06] hover:border-accent-500/30 transition-all duration-500 group relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 h-24 w-24 bg-accent-500/[0.04] blur-2xl opacity-0 group-hover:opacity-100 transition-opacity" />
              
              <div className="h-16 w-16 rounded-2xl bg-white/[0.06] flex items-center justify-center mb-8 group-hover:bg-accent-500 transition-all duration-500 shadow-xl">
                 <detail.icon className="h-8 w-8 text-white/70 group-hover:text-[#090a0d]" />
              </div>
        ...
        >
           ...
           <Link 
             href="/register" 
             className="px-12 py-6 rounded-[2rem] bg-accent-500 hover:bg-accent-400 text-[#090a0d] text-xs font-black uppercase tracking-[0.2em] transition-all shadow-2xl shadow-accent-500/30 hover:scale-105 active:scale-95 flex items-center gap-4 group"
           >
